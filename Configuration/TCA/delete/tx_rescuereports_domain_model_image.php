...
return [
    ...
    'columns' => [
        ...
        'l18n_parent' => ['displayCond' => 'FIELD:sys_language_uid:>:0','label' => 'LLL:EXT:core/Resources/Private/Language/locallang_general.xlf:LGL.l18n_parent','config' => ['type' => 'select','renderType' => 'selectSingle','items' => [['', 0]],'foreign_table' => 'tx_rescuereports_domain_model_image','foreign_table_where' => 'AND {#tx_rescuereports_domain_model_image}.{#pid}=###CURRENT_PID### AND {#tx_rescuereports_domain_model_image}.{#sys_language_uid} IN (-1,0)','default' => 0]],
