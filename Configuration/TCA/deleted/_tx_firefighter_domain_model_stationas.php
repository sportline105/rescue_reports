...
return [
    ...
    'types' => [
        '1' => ['showitem' => 'name, cars, --div--;Access, hidden, starttime, endtime'],
    ],
    'columns' => [
        ...
        'l18n_parent' => ['displayCond' => 'FIELD:sys_language_uid:>:0','label' => 'LLL:EXT:core/Resources/Private/Language/locallang_general.xlf:LGL.l18n_parent','config' => ['type' => 'select','renderType' => 'selectSingle','items' => [['', 0]],'foreign_table' => 'tx_firefighter_domain_model_station','foreign_table_where' => 'AND {#tx_firefighter_domain_model_station}.{#pid}=###CURRENT_PID### AND {#tx_firefighter_domain_model_station}.{#sys_language_uid} IN (-1,0)','default' => 0]],
    ...
    'config' => [
        ...
        'MM' => 'tx_firefighter_station_car_mm', // MM-Tabelle für n:m-Relation
        'size' => 10,
        'maxitems' => 999,
    ]
],
