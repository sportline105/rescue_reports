...
// === Configuration/TCA/tx_rescue_reports_domain_model_brigade.php ===
return [
    'ctrl' => [
        'title' => 'LLL:EXT:rescue_reports/Resources/Private/Language/locallang_db.xlf:tx_rescue_reports_domain_model_brigade',
        'label' => 'name',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'searchFields' => 'name',
        'iconfile' => 'EXT:rescue_reports/Resources/Public/Icons/tx_rescue_reports_domain_model_brigade.png'
    ],
    'types' => [
    ...
    'columns' => [
        ...
        'l18n_parent' => ['displayCond' => 'FIELD:sys_language_uid:>:0','label' => 'LLL:EXT:core/Resources/Private/Language/locallang_general.xlf:LGL.l18n_parent','config' => ['type' => 'select','renderType' => 'selectSingle','items' => [['', 0]],'foreign_table' => 'tx_rescue_reports_domain_model_brigade','foreign_table_where' => 'AND {#tx_rescue_reports_domain_model_brigade}.{#pid}=###CURRENT_PID### AND {#tx_rescue_reports_domain_model_brigade}.{#sys_language_uid} IN (-1,0)','default' => 0]],
