...
// === Configuration/TCA/tx_firefighter_domain_model_image.php ===
return [
    'ctrl' => [
        'title' => 'LLL:EXT:firefighter/Resources/Private/Language/locallang_db.xlf:tx_firefighter_domain_model_image',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'searchFields' => 'title',
        'iconfile' => 'EXT:firefighter/Resources/Public/Icons/tx_firefighter_domain_model_image.svg'
    ],
    'types' => [
    ...
    'columns' => [
        ...
        'l18n_parent' => ['displayCond' => 'FIELD:sys_language_uid:>:0','label' => 'LLL:EXT:core/Resources/Private/Language/locallang_general.xlf:LGL.l18n_parent','config' => ['type' => 'select','renderType' => 'selectSingle','items' => [['', 0]],'foreign_table' => 'tx_firefighter_domain_model_image','foreign_table_where' => 'AND {#tx_firefighter_domain_model_image}.{#pid}=###CURRENT_PID### AND {#tx_firefighter_domain_model_image}.{#sys_language_uid} IN (-1,0)','default' => 0]],
